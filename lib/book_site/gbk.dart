 ...
 */
class Utf8Codec2 extends Encoding {
   ...
   */
  const Utf8Codec2({bool allowMalformed: false})
  ...
  Utf8Encoder2 get encoder {
    print("```` get encoder");
    return const Utf8Encoder2();
  }
 ...
 */
class Utf8Encoder2 extends Converter<String, List<int>> {
  const Utf8Encoder2();
...
//    return utf8Data;
  ...
  StringConversionSink startChunkedConversion(Sink<List<int>> sink) {
    print("```` startChunkedConversion  [$sink]  ");
